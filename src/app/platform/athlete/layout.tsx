...
export default function AthletePlatformLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="platform-shell flex h-screen bg-[#F7F7F5] text-zinc-900 font-sans overflow-hidden">
      ...
      <aside className="hidden lg:flex flex-col w-64 shrink-0 h-full">
        <PlatformSidebar role="athlete" />
      </aside>

      {/* Main Container */}
      <div className="flex flex-col flex-1 overflow-hidden">
        {/* Responsive Topbar */}
        <PlatformTopbar role="athlete" onMenuClick={() => setMobileOpen(true)} />
